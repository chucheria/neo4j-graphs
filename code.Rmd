...
q <- "MATCH path=shortestPath((a1:Actor {name:{a1_name}})-[*]-(a2:Actor {name:{a2_name}})) RETURN path"
names <- list(a1_name=sample(actors$name, 1), a2_name=sample(actors$name, 1))
print(names)
degree <- cypherToList(graph, q, names)
degree[[1]][["path"]][["length"]]
```

We have the degree but it would be nice to have the whole path to see it.
